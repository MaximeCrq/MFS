    ...
    <header>
        <nav id='nav_bar_1'>
            ...
            <ul>
                ...
                <li><a href="/MFS/connexion_inscription" class="<?php echo $header->getClass(); ?>">
                    Connexion/Inscription</a></li>
            </ul>
            <a id="lien_logo_compte" href="/MFS/compte" class="<?php echo $header->getClassNav(); ?>">
                <img id="logo_compte" src="./image/icon_login1.png"></a>
        </nav>
        <nav id='nav_bar_2'>
            <ul class="<?php echo $header->getClassUser(); ?>">
